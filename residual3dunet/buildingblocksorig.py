...
class Decoder(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, conv_kernel_size=3, scale_factor=(2, 2, 2),
    ...
    def forward(self, encoder_features, x):
        ...
        x = self.upsampling(x, encoder_features.size()[2:])
...
def create_decoders(f_maps, conv_kernel_size, conv_padding, layer_order, num_groups, upsample):
